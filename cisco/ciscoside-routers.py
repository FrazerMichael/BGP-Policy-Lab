...
routers = [
    {"hostname": "R1", "AS": "6509", "interfaces" : [
    ...
    {"hostname": "R2", "AS": "6509", "interfaces" : [
    ...
    {"hostname": "R3", "AS": "6509", "interfaces" : [
    ...
    {"hostname": "R4", "AS": "6509", "interfaces" : [
        ...
        {"ip": "10.0.114.1", "netmask": "255.255.252.252", "interface": "f3/0", "type": "external"}
        ],
        "advertising" : [
    ...
    {"hostname": "R5", "AS": "6509", "interfaces" : [
    ...
    {"hostname": "R6", "AS": "6509", "interfaces" : [
    ...
    {"hostname": "R7", "AS": "15296", "interfaces" : [
    ...
    {"hostname": "R8", "AS": "15296", "interfaces" : [
    ...
    {"hostname": "R9", "AS": "15296", "interfaces" : [
    ...
    {"hostname": "R10", "AS": "26677", "interfaces" : [
    ...
    {"hostname": "R11", "AS": "26677", "interfaces" : [
        ...
        "advertising" : [
        {"ip": "38.112.112.0", "netmask": "255.255.254.0", "NxtSlf": "no"},
        {"ip": "66.97.16.0", "netmask": "255.255.224.0", "NxtSlf": "no"},
    ...
    {"hostname": "R12", "AS": "26677", "interfaces" : [
